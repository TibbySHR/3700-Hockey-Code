...
DATA_PATH = Path("data/processed/shots_train.csv")
...
def load_data():
    ...
    # make sure is_goal / empty_net is int
...
def plot_2d_hist_distance_angle(df):
    ...
    # 你可以用 plt.hist2d 或 seaborn.jointplot
    plt.hist2d(
        df["shot_distance"],
        df["shot_angle"],
        bins=[40, 40],
